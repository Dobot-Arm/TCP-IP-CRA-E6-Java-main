...
public class Demo extends JFrame{
    ...
    public Demo(){
        ...
        dashboardPortLabel = new JLabel("Dashboard/Move Port:");
        dashboardPortLabel.setBounds(ipAddressTextField.getX()+150, ipAddressLabel.getY(),170,50);
        ...
        dashboardPortTextField.setBounds(dashboardPortLabel.getX()+180, ipAddressLabel.getY()+10,100,30);
...
//        movePortTextField.setBounds(movePortLabel.getX()+90,ipAddressLabel.getY()+10,100,30);
        ...
        feedBackPortLabel.setBounds(dashboardPortTextField.getX()+120,ipAddressLabel.getY(),150,50);
        ...
        connectButton.setBounds(feedBackPortTextField.getX()+100,ipAddressLabel.getY()+60,130,40);
...
//        mainPanel.add(movePortTextField);
        ...
        connectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Thread whileErrorRunThread = new Thread(){
                    @Override
                    public void run(){
                        while(true){
                            try {
                                ErrorInfoHelper errorInfoHelper = ErrorInfoHelper.getInstance();
                                errorInfoHelper.parseResult(dashboard.getErrorID());
                                Thread.sleep(1000);
...
//                        }
                        ...
                        try {
                            socketClient = new Socket(ip,Integer.valueOf(dashboardPortTextField.getText()));
                            socketClient.setSoTimeout(5000);
                            socketClient.setKeepAlive(true);
                        } catch (IOException ex) {
                            throw new RuntimeException(ex);
                        }
                        if(!dashboard.connect(ip,Integer.valueOf(dashboardPortTextField.getText()),socketClient)){
                        ...
                        if(!dobotMove.connect(ip,Integer.valueOf(dashboardPortTextField.getText()),socketClient)){
                            Logger.instance.log("Connect"+ip+"fail");
                            return;
                        }
                        Logger.instance.log("Connect Success");
                        whileErrorRunThread.start();
        ...
        JLabel controlIOLabel;
        JLabel terminalIOLabel;
        ...
        resetRobotButton = new JButton("Stop Robot");
        ...
        controlIOLabel = new JLabel("控制器 IO");
        controlIOLabel.setBounds(robotConnectTitleLabel.getX(),robotConnectTitleLabel.getY()+250,robotConnectTitleLabel.getWidth()/2,robotConnectTitleLabel.getHeight()/2);
        controlIOLabel.setFont(new Font (Font.DIALOG, Font.PLAIN, 12));
        controlIOLabel.setBorder(BorderFactory.createLineBorder(Color.BLACK));

        digitalOutputsLabel = new JLabel("Digital Outputs:");
        digitalOutputsLabel.setBounds(enableButton.getX()-10,enableButton.getY()+70,120,40);
        digitalOutputsLabel.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        indexlabel = new JLabel("Index:");
        indexlabel.setBounds(digitalOutputsLabel.getX()+140,enableButton.getY()+70,60,40);
        indexlabel.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        indexTextField = new JTextField(6);
        indexTextField.setBounds(indexlabel.getX()+50,enableButton.getY()+70,60,40);
        indexTextField.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        statusLabel = new JLabel("Status:");
        statusLabel.setBounds(indexTextField.getX()+80,enableButton.getY()+70,60,40);
        statusLabel.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        statusComboBox = new JComboBox();
        statusComboBox.addItem("On");
        statusComboBox.addItem("Off");
        statusComboBox.setBounds(statusLabel.getX()+60,enableButton.getY()+70,60,40);
        statusComboBox.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        confirmStatusButton = new JButton("Confirm");
        confirmStatusButton.setBounds(statusComboBox.getX()+80,enableButton.getY()+70,100,40);
        confirmStatusButton.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        terminalIOLabel = new JLabel("末端 IO");
        terminalIOLabel.setBounds(robotConnectTitleLabel.getX()+540,robotConnectTitleLabel.getY()+250,robotConnectTitleLabel.getWidth()/2,robotConnectTitleLabel.getHeight()/2);
        terminalIOLabel.setFont(new Font (Font.DIALOG, Font.PLAIN, 12));
        terminalIOLabel.setBorder(BorderFactory.createLineBorder(Color.BLACK));

        JLabel terminalDigitalOutputsLabel;
        terminalDigitalOutputsLabel = new JLabel("Digital Outputs:");
        terminalDigitalOutputsLabel.setBounds(enableButton.getX()+530,enableButton.getY()+70,120,40);
        terminalDigitalOutputsLabel.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        JLabel terminalIndexlabel;
        terminalIndexlabel = new JLabel("Index:");
        terminalIndexlabel.setBounds(terminalDigitalOutputsLabel.getX()+140,enableButton.getY()+70,60,40);
        terminalIndexlabel.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        JTextField terminalIndexTextField;
        terminalIndexTextField = new JTextField(6);
        terminalIndexTextField.setBounds(terminalIndexlabel.getX()+50,enableButton.getY()+70,60,40);
        terminalIndexTextField.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        JLabel terminalStatusLabel = new JLabel("Status:");
        terminalStatusLabel.setBounds(terminalIndexTextField.getX()+80,enableButton.getY()+70,60,40);
        terminalStatusLabel.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        JComboBox terminalStatusComboBox = new JComboBox();
        terminalStatusComboBox.addItem("On");
        terminalStatusComboBox.addItem("Off");
        terminalStatusComboBox.setBounds(terminalStatusLabel.getX()+60,enableButton.getY()+70,60,40);
        terminalStatusComboBox.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        JButton terminalConfirmStatusButton = new JButton("Confirm");
        terminalConfirmStatusButton.setBounds(terminalStatusComboBox.getX()+80,enableButton.getY()+70,100,40);
        terminalConfirmStatusButton.setFont(new Font (Font.DIALOG, Font.BOLD, 15));

        mainPanel.add(terminalIOLabel);
        mainPanel.add(terminalDigitalOutputsLabel);
        mainPanel.add(terminalIndexlabel);
        mainPanel.add(terminalIndexTextField);
        mainPanel.add(terminalStatusLabel);
        mainPanel.add(terminalStatusComboBox);
        mainPanel.add(terminalConfirmStatusButton);



        mainPanel.add(dashboardFunctionLabel);
        mainPanel.add(controlIOLabel);
        ...
        resetRobotButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Thread thread = new Thread(){
                    @Override
                    public void run(){
                        String reply = dashboard.stopRobot();
                        return;
                    }
                };
                thread.start();
                ...
                Thread thread = new Thread(){
                    ...
                    public void run(){
                        ...
                        if((doIndexInt >= 1 && doIndexInt <= 16)||(doIndexInt >= 100 && doIndexInt <= 1000)){
                            Logger.instance.log(String.format("send to {0}:{1}: DigitalOutputs({2},{3},2000)", ipAddressTextField.getText(),dashboardPortTextField.getText(),doIndexInt, true
                                    ));
                            String str = String.valueOf(statusComboBox.getSelectedItem());
                            if(str.equals("On")){
                                String reply = dashboard.DigitalOutputs(doIndexInt,true,2000);
                            }else {
                                String reply = dashboard.DigitalOutputs(doIndexInt,false,2000);
                            }
                        }else {
        ...
        //terminalConfirmStatusButton
        terminalConfirmStatusButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Thread thread = new Thread(){
                    @Override
                    public void run(){
                        String doIndex = terminalIndexTextField.getText();
                        if(doIndex == null || doIndex.isEmpty()){
                            Logger.instance.log("请输入数字输出索引");
                            return;
                        }
                        Integer doIndexInt = Integer.valueOf(doIndex);
                        if((doIndexInt >= 1 && doIndexInt <= 16)||(doIndexInt >= 100 && doIndexInt <= 1000)){
                            Logger.instance.log(String.format("send to {0}:{1}: ToolDO({2},{3})", ipAddressTextField.getText(),dashboardPortTextField.getText(),doIndexInt, true
                            ));
                            String str = String.valueOf(terminalStatusComboBox.getSelectedItem());
                            if(str.equals("On")){
                                String reply = dashboard.toolDO(doIndexInt,true);
                            }else {
                                String reply = dashboard.toolDO(doIndexInt,false);
                            }
                        }else {
                            Logger.instance.log("请输入正确的数字输出索引");
                        }
        ...
        JointMovJButton = new JButton("MovJ");
        JointMovJButton.setBounds(J6TextField.getX()+100,moveFunctionLabel.getY()+110,100,40);
                ...
                if("Disconnect".equals(connectButton.getText())) {
                    ...
                    if(!socketClient.isClosed()){
                        try {
                            ...
                            Logger.instance.log("DobotMove Close Socket Exception:" + ioe.getMessage());
                        }
                    }else {
